                ...
                ${icon ? `
                    <div class="flex-shrink-0">
                        ${Icon({
                            ...
                            type: iconType,
                            size: 'sm',
                            className: disabled ? 'text-gray-400 dark:text-gray-600' : 'text-gray-500 dark:text-gray-400'
                        })}
                    </div>
                ` : ''}
            ...
            <div class="flex items-center space-x-2 flex-shrink-0">
                ...
                ${rightIcon ? `
                    ${Icon({
                        ...
                        type: iconType,
                        size: 'sm',
                        className: disabled ? 'text-gray-400 dark:text-gray-600' : 'text-gray-400 dark:text-gray-500'
                    })}
                ` : ''}
            </div>
        </${element}>
